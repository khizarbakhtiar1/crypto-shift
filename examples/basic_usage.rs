...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("1️⃣  Creating a classical cryptography policy...");
    ...
    println!("2️⃣  Generating Ed25519 key pair...");
    ...
    println!("4️⃣  Verifying the signature...");
    ...
    println!("5️⃣  Testing with incorrect message...");
